...
func processFile(filename string, useStdin bool) error {
	...
	// HACK: Remove empty lines after the fix
	//       This is necessary because the stupid AST contains positional elements (line numbers)
	//       that are used when rendering the AST back into source code,
	//       and it is super complex to update those positional elements reliably.
